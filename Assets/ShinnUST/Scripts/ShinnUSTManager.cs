...
public class ShinnUSTManager : MonoBehaviour {
    ...
    void Start () 
	{
        ...
        if (!Enable) {
            ...
            data.urgPosOffsetx = PlayerPrefs.GetFloat(name + " URG Offset X");
            data.urgPosOffsety = PlayerPrefs.GetFloat(name + " URG Offset Y");
            data.urgScalex = PlayerPrefs.GetFloat(name + " Scalex", data.urgScalex);
            data.urgScaley = PlayerPrefs.GetFloat(name + " Scaley", data.urgScaley);

            data.urgRotate = PlayerPrefs.GetFloat(name + " Rotate", data.urgRotate);
            
            data.guiScale = PlayerPrefs.GetInt(name + " GUI Scale");
	...
	void OnGUI()
	{
		...
		if (!Enable) {
			...
			if (showGui) {
				...
				GUILayout.Label (" " + name + " URG Status :  " + urgStatus, _style);
    ...
    void SaveData()
    {
        ...
        PlayerPrefs.SetFloat(name + " URG Offset X", urg.PosOffset.x);
        PlayerPrefs.SetFloat(name + " URG Offset Y", urg.PosOffset.y);
        PlayerPrefs.SetFloat(name + " Scalex", urg._Scale.x);
        PlayerPrefs.SetFloat(name + " Scaley", urg._Scale.y);
        PlayerPrefs.SetFloat(name + " Rotate", urg.Rotate);
        //PlayerPrefs.SetFloat(name + " GUI Position", data.guiPos);
        PlayerPrefs.SetInt(name + " GUI Scale", data.guiScale);
    ...
    void Default()
    {
        ...
        PlayerPrefs.SetFloat(name + " URG Offset X", data.urgPosOffsetx);
        PlayerPrefs.SetFloat(name + " URG Offset Y", data.urgPosOffsety);
        PlayerPrefs.SetFloat(name + " Scalex", data.urgScalex);
        PlayerPrefs.SetFloat(name + " Scaley", data.urgScaley);
        PlayerPrefs.SetFloat(name + " Rotate", data.urgRotate);
        //PlayerPrefs.SetFloat(name + " GUI Position", data.guiPos);
        PlayerPrefs.SetFloat(name + " GUI Scale", data.guiScale);
